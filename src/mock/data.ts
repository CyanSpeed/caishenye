...
export const mockCategories: Category[] = [
  // 支出分类（新的12种分类）
  { id: 1, name: '居住与房贷', type: 'expense', icon: 'home', expense_nature: 'fixed', cashflow_type: 'financing' },
  { id: 2, name: '水电燃气与通讯', type: 'expense', icon: 'zap', expense_nature: 'fixed', cashflow_type: 'operating' },
  { id: 3, name: '餐饮与食品', type: 'expense', icon: 'restaurant', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 4, name: '交通与车辆养护', type: 'expense', icon: 'car', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 5, name: '教育与自我提升', type: 'expense', icon: 'book', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 6, name: '医疗与健康', type: 'expense', icon: 'medical', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 7, name: '服饰与个人形象', type: 'expense', icon: 'shirt', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 8, name: '家居日用与耐用品', type: 'expense', icon: 'cart', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 9, name: '休闲娱乐与社交', type: 'expense', icon: 'gamepad', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 10, name: '宠物支出', type: 'expense', icon: 'heart', expense_nature: 'variable', cashflow_type: 'operating' },
  { id: 11, name: '金融与保险支出', type: 'expense', icon: 'shield', expense_nature: 'fixed', cashflow_type: 'financing' },
  { id: 12, name: '其他与杂项', type: 'expense', icon: 'gift', expense_nature: 'variable', cashflow_type: 'operating' },
  // 收入分类
  { id: 13, name: '工资', type: 'income', icon: 'cash', expense_nature: '', cashflow_type: 'operating' },
  { id: 14, name: '投资收益', type: 'income', icon: 'trending-up', expense_nature: '', cashflow_type: 'investing' },
  { id: 15, name: '兼职收入', type: 'income', icon: 'briefcase', expense_nature: '', cashflow_type: 'operating' },
  { id: 16, name: '利息收入', type: 'income', icon: 'percent', expense_nature: '', cashflow_type: 'investing' },
  { id: 17, name: '其他收入', type: 'income', icon: 'gift', expense_nature: '', cashflow_type: 'operating' },
]

export const mockTransactions: Transaction[] = [
  // 分类ID: 1=居住与房贷, 2=水电燃气与通讯, 3=餐饮与食品, 4=交通与车辆养护,
  // 5=教育与自我提升, 6=医疗与健康, 7=服饰与个人形象, 8=家居日用与耐用品,
  // 9=休闲娱乐与社交, 10=宠物支出, 11=金融与保险支出, 12=其他与杂项
  { id: 1, date: '2026-05-02', type: 'expense', amount: '48.50', from_account_id: 4, to_account_id: null, category_id: 3, description: '午餐外卖 - 黄焖鸡米饭', tags: '["餐饮","外卖"]', member_name: '张先生' },
  { id: 2, date: '2026-05-01', type: 'expense', amount: '320.00', from_account_id: 2, to_account_id: null, category_id: 7, description: '优衣库T恤', tags: '["服饰","服装"]', member_name: '张先生' },
  { id: 3, date: '2026-05-01', type: 'income', amount: '28500.00', from_account_id: null, to_account_id: 3, category_id: 13, description: '4月工资', tags: '["工资","固定收入"]', member_name: '' },
  { id: 4, date: '2026-04-30', type: 'expense', amount: '150.00', from_account_id: 5, to_account_id: null, category_id: 3, description: '朋友聚餐AA', tags: '["餐饮","社交"]', member_name: '张先生' },
  { id: 5, date: '2026-04-28', type: 'transfer', amount: '5000.00', from_account_id: 3, to_account_id: 4, category_id: null, description: '转入支付宝日常使用', tags: '["转账","内部"]', member_name: '' },
  { id: 6, date: '2026-04-28', type: 'expense', amount: '2500.00', from_account_id: 2, to_account_id: null, category_id: 1, description: '房租', tags: '["居住","固定支出"]', member_name: '' },
  { id: 7, date: '2026-04-27', type: 'expense', amount: '200.00', from_account_id: 2, to_account_id: null, category_id: 4, description: '加油', tags: '["交通","汽车"]', member_name: '张先生' },
  { id: 8, date: '2026-04-26', type: 'expense', amount: '89.90', from_account_id: 4, to_account_id: null, category_id: 9, description: 'Netflix月费', tags: '["娱乐","订阅"]', member_name: '张先生' },
  { id: 9, date: '2026-04-25', type: 'expense', amount: '380.00', from_account_id: 2, to_account_id: null, category_id: 6, description: '体检', tags: '["医疗","健康"]', member_name: '李女士' },
  { id: 10, date: '2026-04-24', type: 'income', amount: '3500.00', from_account_id: null, to_account_id: 4, category_id: 15, description: '周末培训讲课费', tags: '["兼职","培训"]', member_name: '' },
  { id: 11, date: '2026-04-22', type: 'expense', amount: '6500.00', from_account_id: 2, to_account_id: null, category_id: 1, description: '房贷月供', tags: '["居住","贷款"]', member_name: '' },
  { id: 12, date: '2026-04-20', type: 'transfer', amount: '3500.00', from_account_id: 2, to_account_id: 11, category_id: null, description: '还信用卡', tags: '["转账","还款"]', member_name: '' },
  { id: 13, date: '2026-04-15', type: 'expense', amount: '156.00', from_account_id: 4, to_account_id: null, category_id: 3, description: '超市采购食材', tags: '["餐饮","日常"]', member_name: '李女士' },
  { id: 14, date: '2026-04-10', type: 'income', amount: '1250.00', from_account_id: null, to_account_id: 6, category_id: 14, description: '股票分红', tags: '["投资","分红"]', member_name: '' },
]
